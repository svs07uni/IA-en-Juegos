...
BehaviorPursue.prototype = {
	...
	pursue:function(){
		var targetPosition = 
		new Phaser.Point(
			this.boid.pursuitTarget.getPosition().x + 
			this.boid.pursuitTarget.getVelocity().x*
			this.boid.pursuitPredict,

			this.boid.pursuitTarget.getPosition().y + 
			this.boid.pursuitTarget.getVelocity().y*
			this.boid.pursuitPredict);
		
		var pursuitVec = MovementUtils.seekSteer(
			this.boid.pursuitTarget.sprite.position, 
			this.boid.sprite.position, 
			this.boid.sprite.body.velocity, 
			this.boid.maxPursuitForce, 
			this.boid.maxPursuitSpeed);
